...
export const matches: Match[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    status: 'finished',
    match_end_at: '2026-05-01T12:00:00.000Z', // ~17:00 + 90' + descuentos
    rules: { ...DEFAULT_RULES },
    home: {
      id: 'river',
      name: 'River Plate',
...
periods: {
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    status: 'finished',
    match_end_at: '2026-05-01T12:00:00.000Z', // ~19:30 + 90' + descuentos
    rules: { ...DEFAULT_RULES },
    home: {
      id: 'racing',
      name: 'Racing Club',
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    status: 'finished',
    match_end_at: '2026-05-01T12:00:00.000Z', // ~21:00 + 90' + descuentos
    rules: { ...DEFAULT_RULES },
    home: {
      id: 'san-lorenzo',
      name: 'San Lorenzo',
